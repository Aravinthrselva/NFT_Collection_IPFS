...
using Strings for uint256;
    ...
    // mint allows users to mint 1 NFT per transaction

    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Max supply limit reached");
        require(msg.value >= _price, "Not enough Eth to cover mint price");
        tokenIds += 1;
    ...
    function withdraw() public onlyOwner {
        ...
        require(sent, "ETH withdrawal transaction failed"); 
    }
